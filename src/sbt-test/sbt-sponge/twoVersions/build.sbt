...
lazy val v500 = project in file("5.0.0") enablePlugins SpongePlugin settings(commonSettings: _*) settings(
	spongeApiVersion := "5.0.0-SNAPSHOT"
	)

lazy val v410 = project in file("4.1.0") enablePlugins SpongePlugin settings(commonSettings: _*) settings(
